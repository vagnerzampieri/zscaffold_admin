...
It is a scaffold with configurable layout, controllers, models, helpers, etc. It is installed in the app templates to be used in scaffold. Can be used in applications and other Engines.
